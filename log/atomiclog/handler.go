...
func reload[T slog.Handler](ah *AtomicHandler, file io.Writer, lv slog.Leveler, format clog.LogFormatFunc[T], opts ...clog.SlogOption) {
	...
	handler := clog.GetHandler(file, lv, format, opts...)
...
func NewHandlerFunc[T slog.Handler](format clog.LogFormatFunc[T]) clog.LogFormatFunc[*AtomicHandler] {
